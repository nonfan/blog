...
export default function Home({ searchQuery }: HomeProps) {
  ...
  return (
    <div className="masonry-container">
      ...
      {config.layout.postListView === 'card' ? (
        ...
        <div className="post-list-view">
          {filteredPosts.map((post: Post) => (
            <Link to={`/post/${post.slug}`} key={post.slug} className="post-list-item">
              <div className="post-list-main">
                ...
                <div className="post-list-excerpt">{highlightText(getDisplayExcerpt(post))}</div>
              </div>
